    ...
    return(
        type==="Google"||type==="Google-icon" ? (
            ...
            <svg className="iconAuthenticator" height={ iconHeight } width={ iconWidth } viewBox="0 0 512 512">
                ...
                246.709C.056 249.792 0 252.89 0 256c0 141.385 131.502 246.71 256 246.71 126.754 0 256-105.325
                256-246.71z" fill="#ff5876"/>
                ...
                <path d="M469.419 246.709C464.555 133.042 370.865 42.382 256 42.382S47.445 133.042 42.581 246.709C42.449
                 249.79 42.58 456.03 256 456.03s213.551-206.24 213.419-209.321z" fill="#e4eef9"/>
                <path d="M256 451.037c-114.864 0-208.539-90.662-213.405-204.328a216.93 216.93 0 00-.213 9.29c0 117.978
                95.64 213.618 213.618 213.618S469.618 373.978 469.618 256c0-3.114-.082-6.209-.213-9.29C464.539 360.376
                370.864 451.037 256 451.037z" fill="#d5e0f2"/>
                <path d="M333.595 181.05c-6.089-6.005-15.893-5.938-21.897.15l-36.334 36.837 3.651 17.537 16.972 5.654
                37.759-38.281c6.004-6.088 5.937-15.892-.151-21.897zM234.082 219.447l-82.402-73.432c-6.385-5.69-16.172-5.
                126-21.861 1.259-5.689 6.384-5.126 16.172 1.259 21.861l84.025 74.878 17.509-5.84z" fill="#405b6c"/>
                <path d="M365.636 355.837a7.712 7.712 0 01-4.976-1.814l-98.073-82.378a7.742 7.742 0 019.959-11.856l98
                .073 82.379a7.742 7.742 0 01-4.983 13.669z" fill="#86dcff"/>
                <path d="M215.103 244.013l14.46 12.886 18.57-6.31-1.007-19.519-13.043-11.623c-9.075 5.453-15.944 14.19-
                18.98 24.566zM275.363 218.038l-12.294 12.464v24.466h19.366l13.552-13.739c-3.724-10.076-11.151-18.349-20
                .624-23.191z" fill="#2d4456"/>
                ...
                <g fill="#405b6c">
                    ...
                    7.757-7.757v-24.027a7.757 7.757 0 00-15.514 0zM442.454 263.757a7.757 7.757 0 000-15.514h-24.027a7.
                    757 7.757 0 000 15.514zM69.546 248.243c-4.285 0-7.757 3.473-7.757 7.757s3.472 7.757 7.757 7.757h24.
                    027a7.757 7.757 0 000-15.514z"/>
                </g>
            </svg>
        ):(
            <svg className="icon" width={ iconWidth } height={ iconHeight } viewBox="0 0 512.005 512.005" x={ iconX }
                ...
                <path className="path fill secondary"
                    d="M256.003 234.672c-11.76 0-21.333 9.573-21.333 21.333 0 7.792 4.409 14.329 10.667 18.053v13
                    .947a10.66 10.66 0 0010.667 10.667 10.66 10.66 0 0010.667-10.667v-13.947c6.258-3.724 10.667-10.262 
                    10.667-18.053-.002-11.76-9.575-21.333-21.335-21.333zM256.003 149.339c-17.646 0-32 14.354-32 32v10
                    .667h64v-10.667c0-17.646-14.355-32-32-32z"/>
                <path className="path fill secondary"
                    d="M440.888 64.609l-181.333-64a10.65 10.65 0 00-7.104 0l-181.333 64a10.683 10.683 0 00-7.115 10
                    .063v128c0 165.646 24.563 226.188 187.198 308.188 1.51.76 3.156 1.146 4.802 1.146a10.67 10.67 0 004
                    .802-1.146c162.635-82 187.198-142.542 187.198-308.188v-128c0-4.521-2.855-8.552-7.115-10.063zm-88
                    .885 255.396c0 11.76-9.573 21.333-21.333 21.333H181.336c-11.76 0-21.333-9.573-21.333-21.333V213
                    .339c0-11.76 9.573-21.333 21.333-21.333v-10.667c0-41.167 33.5-74.667 74.667-74.667s74.667 33.5 
                    74.667 74.667v10.667c11.76 0 21.333 9.573 21.333 21.333v106.666z"/>
            </svg>
        )
    );
};
